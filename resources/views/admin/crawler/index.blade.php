    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="box box-solid">
                <form id="artist_save_form" action="{{ route('admin::crawler.index') }}" method="post">
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="control-label">name</label>
                            <input required class="form-control" id="name" name="name" rows="20">{{ old('name') }}
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group{{ $errors->has('url') ? ' has-error' : '' }}">
                            ...
                            <input required class="form-control" id="url" name="url" rows="20">{{ old('url') }}
                            @if ($errors->has('url'))
                        ...
                        <div class="form-group{{ $errors->has('selector') ? ' has-error' : '' }}">
                            ...
                            <input required class="form-control" id="selector" name="selector" rows="20">{{ old('selector') }}
                        ...
                        <div class="form-group{{ $errors->has('title_selector') ? ' has-error' : '' }}">
                            ...
                            <input required class="form-control" id="title_selector" name="title_selector" rows="20">{{ old('title_selector') }}
                        ...
                        <div class="form-group{{ $errors->has('date_selector') ? ' has-error' : '' }}">
                            ...
                            <input required class="form-control" id="date_selector" name="date_selector" rows="20">{{ old('date_selector') }}
                    ...
                    <div class="box-footer">
                        ...
                        <a class="btn btn-default" href="{{ route('admin::crawler.index') }}" target="_blank">@lang('c.preview')</a>
                    </div>
                </form>
            </div>
        </div>
